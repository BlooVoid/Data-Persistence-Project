...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CurrentPlayerName.text = $"Current Player: {MainManager.Instance.PlayerName}"; 
    ...
    {
        int CurrentScore = MainManager.Instance.Score;

        if (CurrentScore > BestScore)
        {
            BestPlayer = MainManager.Instance.PlayerName;
